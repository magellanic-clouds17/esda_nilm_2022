...
train_data_path = r'C:\Users\Latitude\Desktop\Kaggle\esda_nilm_2022\data\processed\df_multico_outlier.csv'
...
l = df_test.columns.difference(df.columns)
...
X_test.to_csv(r'C:\Users\Latitude\Desktop\Kaggle\esda_nilm_2022\data\processed\submission_v3.csv', index=False)
